...
INSERT INTO `berita` (`id`, `judul`, `isi`, `gambar`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Layanan Cuci Motor Terbaru', 'Kami dengan bangga mengumumkan layanan cuci motor terbaru kami yang menggunakan teknologi modern dan produk berkualitas tinggi untuk memberikan hasil terbaik untuk motor Anda.', NULL, 'published', '2025-06-20 18:00:00', '2025-06-20 18:00:00'),
(2, 'Promo Spesial Bulan Ini', 'Dapatkan diskon 20% untuk paket premium dan VIP selama bulan ini. Jangan lewatkan kesempatan ini untuk memberikan perawatan terbaik untuk motor Anda.', NULL, 'published', '2025-06-20 18:00:00', '2025-06-20 18:00:00');
